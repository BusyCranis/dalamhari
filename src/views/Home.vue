            ...
            <v-row align="center" justify="center">
              <v-col cols="12" md="6" xl="8">
                ...
                <h1 class="font-weight-light">
                  ...
                  이게 나라냐?<br />
                  현 정권은 민생은 내팽개치고 수사에만 집중하는 검찰국가로
                  나아가려하고 있다.<br />
                  이제는 우리가 직접 나서야 한다.<br />
                  전국 지역장을 3,000명을 모집한다.<br />
                  아래에서부터 민의를 수렴해서 국가의 주요 이슈까지 시민이 직접
                  결정하는 커뮤니티 시스템 <br />
                  가입하라
                </h1>
                <v-btn
      ...
      features: [
        {
          ...
          title: "지역장이 되세요",
          text: "지역장이 되시면 현실 정치의 모든 현안에 대한 의견들을 아래로부터 모아서 실제 정치인(대통령,국회의원,지방자치단체장)에게 전달하고 그들을 움직일수있습니다.",
        },
        {
          img: require("@/assets/img/icon1.png"),
          title: "",
          text: "정치에 관심이 많은 3백만명의 회원들이 활동하는 커뮤니티입니다.",
        },
        {
